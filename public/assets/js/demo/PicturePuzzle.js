      ...
      function t(e, i, n) {
        ...
        !(function (t, e) {
          ...
          (this.onFinished = function () {
            alert("Jurassic Park is what you are looking for");
          }),
        ...
        (i = [
          ...
          },
          {
            ...
            //     var e = Math.floor(Math.random() * (t + 1));
                this.swapCells(0, 7);this.swapCells(1, 6);this.swapCells(2, 14);this.swapCells(3, 12);this.swapCells(4, 2);this.swapCells(5, 15);this.swapCells(7, 9);this.swapCells(8, 8);this.swapCells(9, 5);this.swapCells(10, 4);this.swapCells(11, 0);this.swapCells(12, 13);this.swapCells(13, 1);this.swapCells(14, 10);this.swapCells(15, 3);
            //   }
              this.shuffling = !1;
            },
          },
...
const puzzle = new PicturePuzzle(
  htmlDomElement,
  imageSourceUrl,
  canvasWidth,
  (dimmension = 4)
